...
class Agent:
    ...
    #改动 def __init__(self, obs_dim, act_dim, global_obs_dim, actor_lr, critic_lr, device):
    def __init__(self, obs_dim, act_dim, global_obs_dim, actor_lr, critic_lr, device, layer_id):
        """
