...
#from multiagent.scenarios.simple_tag import
...
if __name__ == '__main__':
    ...
    parser.add_argument('--episode-num', type=int, default=8000, help='total number of episode')
    ...
    parser.add_argument('--steps-before-learn', type=int, default=7e4,
    ...
    maddpg = MADDPG(obs_dim_list, act_dim_list, args.buffer_capacity, args.actor_lr, args.critic_lr, res_dir)#基本传入的是超参数，那么我这里的id应该传入list？
